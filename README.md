...
- `docs/design/megacu_cpp_cuda_layer.md` for the accepted device-native layer
  design
- `docs/design/runtime_architecture.md` for the implemented runtime-linked
  architecture
- `docs/design/program_compile_execute_flow.md` for the program, compile, and
  execution flow
- `docs/design/launch_adapters_and_verification.md` for direct, MPI, Torch,
