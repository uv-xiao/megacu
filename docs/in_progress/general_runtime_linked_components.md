...
implementation started. Compact arena records, `host_orch::frame`, and the
`runtime_execution_models_contracts` build test now exist. Seeded-orch,
runtime composition, and example integration remain pending.
